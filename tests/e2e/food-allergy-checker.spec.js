...
const SVC_URL = "https://appadaycreator.com/food-allergy-checker/";
const SVC_NAME = "食物アレルギー・除去食診断";

test.describe("食物アレルギー・除去食診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("food-allergy-checker");
